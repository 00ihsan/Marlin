...
#define STRING_CONFIG_H_AUTHOR "(1H54N, Ihsansoft-3D)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ihsansoft 3D"
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_INDEX_FIRST  15              // Index of the first background LED
  #define NEOPIXEL_BKGD_INDEX_LAST   32              // Index of the last background LED
  #define NEOPIXEL_BKGD_COLOR { 100, 100, 100, 0 }  // R, G, B, W
